...
void RollingObstacle::drawTriangle(Vector3f& p1,
                                   Vector3f& p2,
                                   Vector3f& p3,
                                   RollingBall* ball,
                                   vector<Vector3f>* collision_points) {
...
void BoxObstacle::drawFace(RollingBall* ball, vector<Vector3f>* collision_points, // 
                                       Vector3f& center,
                                       Vector3f& u_dir, float u,
                                       Vector3f& v_dir, float v) {
    Vector3f du = u_dir * u / 2.0;
    ...
    drawTriangle(p1, p2, p3, ball, collision_points);
    drawTriangle(p3, p4, p1, ball, collision_points);    
};

void BoxObstacle::drawObstacle(RollingBall* ball, vector<Vector3f>* collision_points) {
    Vector3f x = Vector3f(1, 0, 0);
    Vector3f y = Vector3f(0, 1, 0);
    Vector3f z = Vector3f(0, 0, 1);
    ...
    Vector3f c_pos_x = center + x * w_x_ / 2.0;
    Vector3f c_neg_x = center - x * w_x_ / 2.0;    
    drawFace(ball, collision_points,
                         c_pos_x,
                         y, w_y_,
                         z, w_z_);
    drawFace(ball, collision_points,
...
void BoxObstacle::draw() {
    vector<Vector3f>c_pts;
    RollingBall tmp_ball(Vector3f(0, 0, 0), 1.0);
    drawObstacle(&tmp_ball, &c_pts);
    return;
