...
RollingUI::RollingUI() {
  { window = new Fl_Double_Window(1101, 816, "Rolling Sphere");
    window->user_data((void*)(this));
    { scene_view = new RollingView(0, 52, 1100, 739, "OpenGL View");
    ...
    { Fl_Menu_Bar* o = new Fl_Menu_Bar(0, 0, 1100, 25);
      o->box(FL_BORDER_BOX);
      o->menu(menu_);
    } // Fl_Menu_Bar* o
    { status_bar = new Fl_Group(0, 790, 1100, 25);
